...
<html>
    <head>
        ...
        <title>Teq strukturunu redaktə edin</title>
    ...
    <body id="tags_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="findTag.jsp" class="footmenu">Sonlandır</a></li>
        ...
        <div class="menu aui-overlaycontext-hidden">
            <ul><li class="item-add c "><a >Kateqoriya əlavə et</a></li>
                <li class="item-move np"><a >Yerini dəyiş</a></li>
                <li class="item-kill np"><a >Sil</a></li>
                <li class="item-change np" id="item-change"><a >Adını dəyiş</a></li>
                <li class="file-change np" id="file-change"><a >Dəyişikliyin sahibi</a></li>
                <li class="file-add c " id="file-add"><a >Teq əlavə et</a></li></ul></div>
        <div id="moveMain"><div class="close" id="closeM"><span>BAĞLA</span></div><div id="Move"></div></div>
        <div id="form"><div class="close" id="close"><span>BAĞLA</span></div>
            <form id="FILEFORM" action="addTag" method="POST">
                <label for="name">Ad</label><input type="text" name="name" id="name">
                <label for="discription">Sahibi</label><select name="owner" id="owner"><%= list%></select><br><br>
        ...
        <script type="text/javascript">
            ...
            else alert("Yalnız boş bölməni silə bilərsiniz. Bölmənin məzmununu silmək lazımdır!")
            }
            ...
            var name = window.prompt("bölmənin və ya teqin yeni adını daxil edin", html.text());
