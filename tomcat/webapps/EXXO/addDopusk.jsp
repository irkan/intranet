...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="LIST" class="BEANS.addDopuskBean" scope="page"/><%
...
<html>
    <head>
        ...
        <style><%=CSS3.getCSS("addDopusk.jsp", request)%></style>
    </head>
    <body id="addDopusk_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li> 
                                            <a href="http://exxo.ru/howto/documents-howto.html#admit" class="footmenu howto" target="_blank">?</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
            ...
            AUI().ready('aui-node', 'aui-button-item', 'aui-io', function (A) {
                A.all("#list tr").each(function () {
                    ...
                    this.on("click", function () {
                        location = "addDopusk?dopusk=" + this.one(".fio span").getAttribute("id") + "&id=<%=id%>&owner=<%=owner%>"
                    });
