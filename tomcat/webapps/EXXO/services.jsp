...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="SER" class="BEANS.Services" scope="page"/><%
    String list = SER.getList(request);
...
<html>
    <head>
        ...
        <title>Xidmətlərin siyahısı</title>
        ...
        <style type="text/css">
            ...
            .first {width:25%;padding-top:10px; padding-left: 5px; text-align: left;}
            .second{width:50%;padding-top:10px; padding-left: 5px; text-align: left;}
            .third{padding-top:10px; padding-left: 5px; text-align: left;}
            #content table td{padding: 4px;border-bottom-color: #DEDEDE;border-bottom-style: solid;border-bottom-width: 1px;}
            .stoped td {color:gray;}
        </style>
        <style>
            <%=CSS.getCSS(request)%>
        </style>
        <style>
            <%=CSS3.getCSS("services.jsp", request)%>
        </style>
    </head>
    <body id="services_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="processIns.jsp" class="footmenu">Redakrə et</a></li>
            ...
            AUI().ready('aui-node', function (A) {
                A.all("#content .datas").each(function () {
                    ...
                    this.on("click", function () {
                        location = "serviceCard.jsp?id=" + this.one(".first").getAttribute("id")
                    });
