    ...
    <body id="serviceCard_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li>
                                            <a href="processUpd.jsp?id=<%=id%>" class="footmenu">Redaktə et</a>
                                        </li>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="left">
                                                ...
                                                <div class="maininfo insp" id="inspector"><a href="empCard.jsp?id=<%=supervisor%>"> İNSPEKTOR</a></div>
        ...
        <script  type="text/javascript">
            AUI().ready('anim', 'aui-overlay-mask', 'aui-button-item', function (A) {
                ...
                new A.ButtonItem({icon: 'transferthick-r-l', label: 'Davam edin', handler: {fn: function (e) {
            <% if (stoped.equals("0")) { %>
                            A.one('#pool').fx.run();
            <% } else { %>
