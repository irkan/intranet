...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="FG" class="BEANS.newPhotosList" scope="page"/><%
...
<html>
    <head>
        ...
        <title>Новые фотографии Таблица</title>
        ...
        <style>
            <%=CSS3.getCSS("newPhotosList.jsp", request)%>
        </style>
    </head>
    <body class="yui-skin-sam" id="newPhotosList_jsp">
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="menuList">
                                <a href="newPhotos.jsp">В виде галереи</a>
                            </div>
                        </td>
