...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="MS" class="BEANS.MyServices" scope="page"/><%
    String id = (String) session.getAttribute("id");
    String list = MS.getList(id, request);
...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .third{width:30%;padding-top:10px;}
        ...
        <style><%=CSS.getCSS(request)%></style><style><%=CSS3.getCSS("myServices.jsp", request)%></style>
    </head>
    <body id="myServices_jsp">
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="menuTab"><a href="myServicesCSV?id=<%= id%>"><img src="img/ico/table.png" /> məlumatın ixracı</a></div>
                        </td>
            ...
            AUI().ready('aui-node', function (A) {
                A.all("#content .datas").each(function () {
                    ...
                    this.on("click", function () {
                        location = "operationCard.jsp?id=" + this.one(".second").text()
                    });
