...
<html>
    ...
    <body class="yui3-skin-sam" id="logoIns_jsp">
                            ...
                            <div id="content"  class="exxo-shadow">
                                <form method="POST" id="form" name="form" action="sloganIns">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="left"><label>Loqo</label></td>
                                                <td class="right">
                                                    <div id="img"><% if (photoMarker != null) { %> <img src="logo.png" > <% } %></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="left"><label>Sloqan</label></td>
                                                <td class="right"><input name="slogan" type="text" class="formEl" <%if (slogan1 != null) {%> value="<%=slogan1%>" <% } %>></td></tr></tbody></table>
                                    <div id="submit-button">
                                        <input type="submit" value="Slogan yadda saxla" id="ok">
                                    </div>
                                </form>
                            </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            <% if (request.getParameter("message") != null) { %> alert("Şəkilin ölçüsü 10Mb aşır!");<%}%>
            });
        </script>
    </body>
</html>