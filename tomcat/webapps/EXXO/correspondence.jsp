                                    ...
                                    <tr>
                                        ...
                                        <td id="tdinfo"  valign="top">
                                            ...
                                            <div id="info" class="exxo-shadow">
                                                ...
                                                <table>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-folder-open"></span></td><td class="mem-label"> &#151; Qovluq yarat</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-pencil"></span></td><td class="mem-label"> &#151; Yeni mesajlar</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-star"></span></td><td class="mem-label"> &#151; «Vacib» kimi qeyd et /  Vacibliyi ləğv et</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-closethick"></span></td><td class="mem-label"> &#151; Mesajı gizlət və ya qovluğu sil</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-arrow-4"></span></td><td class="mem-label"> &#151; Mesajın və ya qovluğun yerini dəyiş</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-gear"></span></td><td class="mem-label"> &#151; Mesajın atributunu və ya qovluğun adını dəyiş</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-mail-open"></span></td><td class="mem-label"> &#151; Mesajı aç</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-tag"></span></td><td class="mem-label"> &#151; Oxşar mesajları tap</td></tr>
                                                </table>
                                                <div class="mems">Mesajı seçmək üçün üzərinə basın. &#151; Seçimi ləğv etmək üçün yenidən basın və ya başqa elementə vurun.</div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
