...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="LIST" class="BEANS.BlogDopPhoto" scope="page"/><%
...
<html>
    <head>
        ...
        <style>
            <%=CSS3.getCSS("blogDopPhoto.jsp", request)%>
        </style>
    </head>
    <body id="blogDopPhoto_jsp">
