...
<html>
    <head>
        ...
        <title>Portalın redaktəsi</title>
        <style type="text/css">
            ...
            .yui-skin-sam .yui-toolbar-container .yui-toolbar-imgMyK-selected span.yui-toolbar-icon {
                background-image: url("imgK.gif");background-position: 1px 1px;background-repeat: no-repeat;left: 5px;}
            #imges {position:relative;width:auto;height:auto;margin: 4px; background-color:rgb(250,250,250);border: 1px solid #bfbfbf; border-radius: 5px;}
            ...
            #imgesContainer {position: absolute;background-color: transparent;  width: 100%; height: auto; z-index: 99999999;display:none; left:0px; top: 0px;}
        </style>
        <script src="/FILES/alloy/build/aui/aui.js" type="text/javascript"></script>
        <style><%=CSS.getCSS(request)%></style><style><%=CSS3.getCSS("editor.jsp", request)%></style>
    </head>
    <body class="yui-skin-sam" id="editor_jsp">
        <div id="topMenu">
            <div id="foot">
                <ul class="topMenu">
                    <jsp:include page="topMenu.xhtml" flush="true" />
                    <li><a href="main.jsp?id=<%=b%>" class="footmenu">Sonlandır</a></li>
        ...
        <form action="text" method="post">
            <table id="content"><tr><td id="menu">
                        <input type="submit" id='submit' value="Yadda saxla"/>
                        <a href="htmlEditor.jsp?id=<%=id%>&b=<%=b%>" class="html">Redaktə HTML</a>         
        ...
        <div id="imgesContainer">
            <div id="imges">
                <div id="close">
                    <span class="exxo-anim-closer">BAĞLA</span>
                </div>
        ...
        <script type="text/javascript">
            AUI().ready('anim', 'aui-io', 'aui-resize', 'imageloader', 'aui-overlay-mask', function (A) {
                ...
                var io = A.io.request('textOutEdit', {
                ...
                A.one('#imgesContainer').setStyle('opacity', '0');
                function editorPut() {
                    ...
                    myEditor.on('toolbarLoaded', function () {
                        ...
                        var flickrConfig = {type: 'push', label: 'Əməkdaşın fotosunu yerləşdir', value: 'imgEmp'}
                        ...
                        var imgMyConfig = {type: 'push', label: 'Mənim qalareyamdan foto yerləşdir', value: 'imgMy'}
                        ...
                        var imgMyKConfig = {type: 'push', label: 'Ümumi qalareyadan foto yerləşdir', value: 'imgMyK'}
                ...
                if (myHeight < 250)
                    myHeight = 250;
                var node = A.one(A.one("#imgesContainer"));
                ...
                A.one('#imges').setStyle("minHeight", A.DOM.winHeight() - 10 + "px");
            });
        </script>
    </body>
</html>