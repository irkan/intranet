<%@page contentType="text/html" pageEncoding="UTF-8"%><jsp:useBean id="HTML" class="BEANS.html" scope="application"/>
<%
...
<html>
    ...
    <body id="htmlEditor_jsp">
        ...
        <form action="alterHTML" method="post">
            <table id="content">
                <tr>
                    <td id="menu">
                        <input type="submit" id='submit' value="Yadda saxla"/>
                        <a href="editor.jsp?id=<%=id%>&b=<%=b%>" class="html">Визуальный редактор</a>       
                    </td>
                    <td id="editor-center">
