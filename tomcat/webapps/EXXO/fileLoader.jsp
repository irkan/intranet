...
<html>
    ...
    <body class="yui-skin-sam">
        ...
        <div id="form1">
            <div class="close" id="close"><span>BAĞLA</span></div>
        ...
        <div id="loaders"><div class="close" id="close"><span>BAĞLA</span></div><%=ND.loads_list%></div>
        <div id="docStat"><div class="close" id="closes"><span>BAĞLA</span></div><div id="docstatus"></div></div>
        <div id="moveMain">
            <div id="imgesInner">
            ...
            AUI().ready('anim', 'aui-toolbar', 'aui-overlay-mask', 'aui-io', function (A) {
                ...
                if (A.one('#buttonsDons') != null)
                    new A.Toolbar({activeState: false, children: [
                            ...
                            {label: 'Yadda saxla', icon: 'disk', handler: {fn: function (e) {
