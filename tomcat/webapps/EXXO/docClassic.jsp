                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="documentsMod.jsp<% if (owner != null) {%>?owner=<%=owner%><%}%>" class="footmenu">Redaktə et</a></li>
                                            <% if (editable) {%>
                        ...
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="counts" class="exxo-shadow">
                                <table>
                                    ...
                                    <% if (owner == null || !owner.equals("-100")) {%>
                                    <tr><td>boş:</td><td class="res"><%=free%></td></tr>
                                            <% }%>
                                </table>
                            </div>
                            <%= DC.href%></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="tdinfo"  valign="top">
                                            ...
                                            <div id="info" class="exxo-shadow">
                                                <%if (editable) {%>
                                                <table>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-folder-open"></span></td><td class="mem-label"> &#151; Kataloq əlavə et</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-document"></span></td><td class="mem-label"> &#151; Fayl əlavə et</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-copy"></span></td><td class="mem-label"> &#151; Fayllar əlavə et</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-plusthick"></span></td><td class="mem-label"> &#151; Versiya əlavə et</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-closethick"></span></td><td class="mem-label"> &#151; Fayl və ya kataloqu sil</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-arrow-4"></span></td><td class="mem-label"> &#151; Fayl və ya kataloqun yerini dəyişdir</td></tr>
                                                    <tr class="mem"><td><span class="aui-icon aui-icon-gear"></span></td><td class="mem-label"> &#151; Fayl və ya kataloqun attributlarını redaktə et</td></tr></table>
                                                                <%}%>
                                                <div class="mems">Faylı seçmək üçün üzərinə basın. Seçimi ləğv etmək üçün - yenidən basın və ya başqa elementə vurun.</div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
