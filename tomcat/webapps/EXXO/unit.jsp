...
<html>
    <head>
        ...
        <title>İnformasiya alt bölmə</title>
    ...
    <body id="unit_jsp">
        <div id="content-wrapper">
            <div id="header">
                <table id="tableH">
                    <tbody>
                        <tr>
                            <td id="tdlogo"><img src="logo.png" id="logo"></td><td>
                                <div id="head"><table><tbody><tr><td id="slogan" valign="center"><%= slogan%></td><td><jsp:include page="poisk" flush="true" />
                                                </td></tr></tbody></table></div><div id="foot"><ul class="topMenu"><jsp:include page="topMenu.xhtml" flush="true" /><li><a href="unitEditor.jsp?id=<%= id%>" class="footmenu">Redaktə et</a></li>
        ...
        <div id="imger" class="exxo-imger"><div id="close"><span>BAĞLA</span></div><div id="imgerViewer"></div></div>
