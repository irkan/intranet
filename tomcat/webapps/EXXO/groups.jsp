...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="T" class="BEANS.groupBean" scope="page"/><%
    String pr = request.getParameter("id");
    String user = (String) session.getAttribute("id");
    String list = T.getList(pr, request);
...
<html>
    <head>
        ...
        <style>
            <%=CSS3.getCSS("groups.jsp", request)%>
        </style>
    </head>
    <body id="groups_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="groupList.jsp?pr=<%=pr%>" class="footmenu">Настройка</a><li>
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="menuList"><a href="projects.jsp">Перейти к списку проектов</a></div>
                        </td>
            ...
            AUI().ready('aui-node', function (A) {
                A.all("#content .datas").each(function () {
                    ...
                    this.on("click", function () {
                        location = "group.jsp?id=" + this.one(".first").get("id") + "&pr=<%=pr%>"
                    });
