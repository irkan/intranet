...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="NGK" class="BEANS.NewGal" scope="page"/><%
...
<html>
    <head>
        ...
        <title>Новые фотоальбомы сотрудников</title>
        ...
        <style type="text/css">
            ...
            #picTable td.author {text-align: center;}
        ...
        <style>
            <%=CSS3.getCSS("newGal.jsp", request)%>
        </style>
    </head>
    <body class="" id="newGal_jsp">
