...
<html>
    <head>
        ...
        <title>Proyektlərin siyahısı. Redaktə et!</title>
    ...
    <body class="yui3-skin-sam" id="resourceMode_jsp">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    ...
                                    <a href="resources.jsp" class="footmenu">Sonlandır</a>
                            ...
                            <div id="menuT" class="exxo-shadow"><div>
                                    <form action="javascript:;">
                                        <select id="offices" name="offices">
                                            <option value="0" selected="selected">--Resursu seçin--</option>
                                            <%=op%>
                                        </select>
                                        <select id="action" name="action" disabled="true">
                                            <option value="0" selected="selected">--Əməliyyat seçin--</option>
                                            <option value="changeRes">Məlumatı dəyişdir</option>
                                            <option value="dropRes">Resursu sil</option>
                                        </select>
                                    </form>
                                    <div id="button"></div>
                                    <div id="button1"></div>
        ...
        <div id="addNew"><div id="close"><span>BAĞLA</span></div>
            <form action="addRes" method="POST" id="forma" >
                ...
                <label for="short">Resurs</label><input id="short" type="text" name="short">
                <label for="comment">Açıqlama</label><input id="comment" type="text" name="comment">
                <br><br>
        ...
        <div id="drop">
            ...
            <form action="dropRes" method="POST" id="dropForma">
                ...
                <input type="button" value="Yox" id="no">
            </form>
        </div>
        ...
        <script type="text/javascript">
            AUI().ready('aui-button-item', 'anim', 'aui-overlay-mask', function (A) {
                ...
                new A.ButtonItem({
                    icon: 'plus', label: 'Resurs əlavə et', handler: {fn: function (e) {
