...
<jsp:useBean id="CSS" class="BEANS.CSSTotal" scope="application"/><jsp:useBean id="CSS1" class="BEANS.cssPage" scope="page"/>
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><%
    ...
    String css = CSS1.getCSS(id, request);
%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <title>Добавление стиля страницы сервиса</title>
        ...
        <style><%=CSS.getCSS(request)%></style><style><%=CSS3.getCSS("styleP.jsp", request)%></style>
    </head>
    <body class="yui3-skin-sam" id="styleP_jsp">
        <div id="content-wrapper">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="foot"><jsp:include page="topMenu" flush="true" /><a href="main.jsp?id=<%= id%>" class="footmenu">Sonlandır</a>
                                    <a href="http://exxo.ru/howto/cms-howto.html#css" class="footmenu howto" target="_blank">?</a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tr id="tr">
                        ...
                        <td id="column-3" valign="top">
                            <div id="content" class="exxo-shadow" >
                                <h3>Вставьте стиль для этой страницы</h3>
                                <div id=formcss>
            ...
            <jsp:include page="FOOTER" flush="true" /></div><div id="menus" class="yui3-menu"><jsp:include page="menu.jsp" flush="true" /></div>
