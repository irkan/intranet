...
<html>
    ...
    <body id="findTag_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li>
                                            <a href="tags.jsp" class="footmenu">Redaktə et</a>
                                        </li>
                                        <li> 
                                                        ...
                                                        <td>
                                                            <div id="op">
                                                                <select name="tagAim" id="tagAim">
                                                                    <option value="bloges" <%if (s.equals("bloges")) {%>SELECTED <%}%>>Mesajlarda axtarış</option>
                                                                    <option value="files" <%if (s.equals("files")) {%>SELECTED <%}%>>Fayllarda axtarış</option>
                                                                    <option value="gallaries" <%if (s.equals("gallaries")) {%>SELECTED <%}%>>Şəkillərdə axtarış</option>
                                                                </select>
                                                            </div>
                                                        </td>
                                                        <td>
        ...
        <div id="imger"><div id="closser"><span>BAĞLA</span></div><div id="imgerViewer"></div></div>
