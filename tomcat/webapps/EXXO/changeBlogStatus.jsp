...
<html>
    <head>
        ...
        <title>Блокировка документа</title>
        ...
        <style>
            <%=CSS3.getCSS("changeBlogStatus.jsp", request)%>
        </style>
    </head>
    <body id="changeBlogStatus_jsp">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    ...
                                    <a href="javascript:;" class="footmenu" id="back">Sonlandır</a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        ...
                        <td id="column-3" valign="top">
                            <jsp:include page="changeBlogStatus.xhtml" flush="true" />
                        </td>
                    </tr>
                </tbody>
            </table>
            <jsp:include page="FOOTER" flush="true" />
        </div><div id="menus" class="aui-menu">
