...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="ND" class="BEANS.EmpDoc" scope="page"/><%
...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            <% if (!itsMe) { %>a.nopend {font-weight: bold;}<%}%>
        ...
        <style><%=CSS.getCSS(request)%></style><style><%=CSS3.getCSS("empDoc.jsp", request)%></style>
    </head>
    <body id="empDoc_jsp">
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="menuList"><a href="docClassic.jsp<%=ll%>" id="addgroup">qovluq strukturu</a></div>
                        </td>
