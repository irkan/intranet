...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="SC" class="BEANS.ServControl" scope="page"/><%
    boolean BOSS = false;
    ...
    String list = SC.getList(BOSS, id, request);
...
<html>
    <head>
        ...
        <style>
            <%=CSS3.getCSS("servControl.jsp", request)%>
        </style>
    </head>
    <body id="servControl_jsp">
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="menuTab">
                                <a href="servControlCSV?id=<%= id%>"><img src="img/ico/table.png" /> экспорт данных</a>
                            </div>
                        </td>
