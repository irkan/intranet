...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="BLOG" class="BEANS.NewBlogsB" scope="page"/><%
...
<html>
    <head>
        ...
        <title>Yeni mesajlar "iş üçün"</title>
        ...
        <style>
            <%=CSS3.getCSS("newBlogsB.jsp", request)%>
        </style>
    </head>
    <body id="newBlogsB_jsp">
                    ...
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            <div class="exxo-menu exxo-shadow" id="menu">
                                ...
                                <% if (inspector) { %>
                                <a href="listBlogs.jsp">Moderasiya</a>
                                <% }%>
                            </div>
