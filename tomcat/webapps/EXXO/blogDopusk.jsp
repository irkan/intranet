...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="LIST" class="BEANS.blogDopuskBean" scope="page"/><%
...
<html>
    <head>
        ...
        <style>
            <%=CSS3.getCSS("blogDopusk.jsp", request)%>
        </style>
    </head>
    <body id="blogDopusk_jsp">
            ...
            AUI().ready('aui-node', 'aui-button-item', 'aui-io', function (A) {
                A.all("#list tr").each(function () {
                    ...
                    this.on("click", function () {
                        location = "blogDopusk?dopusk=" + this.one(".fio span").getAttribute("id")
                    });
