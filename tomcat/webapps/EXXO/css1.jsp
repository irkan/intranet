...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><%
    ...
    String css = CSS3.getCSS(pages, request);
%>
...
<html>
    <head>
        ...
        <style><%=CSS.getCSS(request)%></style><style><%=CSS3.getCSS("css1.jsp", request)%></style>
    </head>
    <body class="yui3-skin-sam" id="css1_jsp">
        <div id="content-wrapper">
                    ...
                    <tr id="tr">
                        ...
                        <td id="column-3" valign="top">
                            <div id="content"  class="exxo-shadow">
                                <h3>Вставьте стиль для страницы сервиса</h3>
                                <div id=formcss><form action="cssServer" method="POST">
            ...
            <jsp:include page="FOOTER" flush="true" /></div>
        ...
        <script type="text/javascript">
            AUI().ready('node-menunav', 'aui-button', function (A) {
