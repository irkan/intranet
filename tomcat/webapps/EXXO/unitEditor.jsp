...
<html>
    ...
    <body class="yui-skin-sam" id="unitEditor_jsp">
        <div id="topMenu"><div id="foot"><ul class="topMenu">
                    <jsp:include page="topMenu.xhtml" flush="true" /><li><a href="unit.jsp?id=<%=id%>" class="footmenu">Sonlandır</a></li>  
        ...
        <form action="unitText" method="post">
            <table id="content"><tr><td id="menu">
                        ...
                        <a href="unitHtmlEditor.jsp?id=<%=id%>" class="html">Redaktə HTML</a>         
        ...
        <div id="imges"><div id="imgesInner">
                <div id="close"><span class="exxo-anim-closer">BAĞLA</span></div><div id="inserter" class="exxo-images"></div></div></div>
            ...
            AUI().ready('anim', 'aui-io', 'aui-resize', 'imageloader', 'aui-overlay-mask', function (A) {
                ...
                function editorPut() {
                    ...
                    myEditor.on('toolbarLoaded', function () {
                        ...
                        var imgMyConfig = {type: 'push', label: 'Fotonu qalareyamdan yerləşdir', value: 'imgMy'}
                        ...
                        var imgMyKConfig = {type: 'push', label: 'Fotonu ümumi qalareyadan yerləşdir', value: 'imgMyK'}
