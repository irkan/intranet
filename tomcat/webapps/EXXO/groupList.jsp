...
<html>
    <head>
        ...
        <style><%=CSS.getCSS(request)%></style><style><%=CSS3.getCSS("groupList.jsp", request)%></style>
    </head>
    <body id="groupList_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="javascript:;" class="footmenu" id="finish">Sonlandır</a></li>
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            <div class="exxo-menu exxo-shadow" id="menu"><jsp:include page="menu-emp.xhtml" flush="true" /></div>
                            <div id="menuList"><a href="javascript:;" id="addgroup">Добавить рабочую группу</a></div>
                        </td>
                        <td id="column-3" valign="top"><jsp:include page="groupList.xhtml" flush="true" /></td>
                    </tr> 
                </tbody>
            </table>
        ...
        <div id="docStat">
            <div id="imgesInner">
                <div class="close" id="closes"><span>BAĞLA</span></div>
