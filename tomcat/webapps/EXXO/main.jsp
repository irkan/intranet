            ...
            <div class="portlet-list">
                <div id="selects">
                    <select id="op1" name="op1">
                        ...
                        <option value="albums"> fotoalbomlar </option>
                    ...
                    <select id="op5" name="op5" class="other">
                        ...
                        <option value="6">alt bölmələr</option>
                        <option value="7">hamsı</option>
                    </select>
                    <select id="op6" name="op6" class="other">
                        <option value="1" SELECTED>Sənədlərim</option>
                        <option value="2">Gələnlər</option>
                        <option value="3">Общие компании</option>
                        <option value="4">Gələnlər şirkətə</option>
                        <option value="5">Göndərilənlər</option>
                ...
                <div class="portlet-item" id="text-element"><span class="aui-button-icon aui-icon aui-icon-document"></span>Mətn elementi</div>
                <div class="portlet-item" id="my-calendar"><span class="aui-button-icon aui-icon aui-icon-calendar"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item" id="my-birthday"><span class="aui-button-icon aui-icon aui-icon-heart"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item" id="my-NC"><span class="aui-button-icon aui-icon aui-icon-person"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item my-D" id="my-D"><span class="aui-button-icon aui-icon aui-icon-copy"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item" id="my-news"><span class="aui-button-icon aui-icon aui-icon-document-b"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item" id="my-gal"><span class="aui-button-icon aui-icon aui-icon-folder-open"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item" id="my-Kgal"><span class="aui-button-icon aui-icon aui-icon-folder-open"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item" id="my-desk"><span class="aui-button-icon aui-icon aui-icon-notice"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item my-B" id="my-B"><span class="aui-button-icon aui-icon aui-icon-note"></span>İstənilən yerə sürükləyin</div>
                <div class="portlet-item" id="my-P"><span class="aui-button-icon aui-icon aui-icon-image"></span>İstənilən yerə sürükləyin</div>
            </div>
        </div>
