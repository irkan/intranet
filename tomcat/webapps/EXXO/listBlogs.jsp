...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="BLOG" class="BEANS.ListBlogs" scope="page"/><%
    ...
    String list = BLOG.getList(request);
...
<html>
    <head>
        ...
        <title>Mesajların siyahısı moderator üçün</title>
        ...
        <style>
            <%=CSS3.getCSS("listBlogs.jsp", request)%>
        </style>
    </head>
    <body id="listBlogs_jsp">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu"><jsp:include page="topMenu.xhtml" flush="true" /></ul>
                                </div>
                            </td>
                        </tr>
                    </tbody>
