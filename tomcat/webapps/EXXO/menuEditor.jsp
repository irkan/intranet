...
<html>
    ...
    <body  class="yui3-skin-sam" id="menuEditor_jsp">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    ...
                                    <a href="main.jsp" class="footmenu">Sonlandır</a>  <a href="http://exxo.ru/howto/cms-howto.html#menu" class="footmenu howto" target="_blank">?</a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="plus">
                                <span class="aui-button-icon aui-icon aui-icon-plusthick"></span><a href="javascript:;" id="top">Alt menyu əlavə et</a>
                            </div>
                        </td>
        ...
        <div class="menu1 aui-overlaycontext-hidden exxo-shadow">
            <ul><li class="item-up"><a >yuxarı keçid</a></li>
                <li class="item-down"><a >aşağı keçir</a></li>
                <li class="item-kill"><a >sil</a></li>
                <li class="item-add"><a >punk əlavə et</a></li>
                <li class="item-submenu"><a >alt menyu əlavə əlavə et</a></li>
                <li class="item-change" id="item-change"><a >dəyişdir</a></li>
                <li class="item-add-new"><a >yeni pəncərədə</a></li></ul>
        </div>
            ...
            AUI().ready('aui-overlay-context', 'aui-io-request', function (A) {
                ...
                function itemAdd(node, blank) {
                    ...
                    if (node.hasClass('item-menu'))
                        node.one('ul').append('<li class="yui3-menuitem item"><a class="yui3-menuitem-content" href="#"' + target + '>Yeni punkt</a></li>');
                    else
                        node.get('parentNode').append('<li class="yui3-menuitem item"><a class="yui3-menuitem-content" href="#"' + target + '>Yeni punkt</a></li>');
                    menuOverlay.hide();
                }
                function itemSubmenu(node) {
                    var D = new Date();
                    var id = 'li_' + D.getTime() + '-' + user;
                    var str = '<li class="yui3-menuitem item-menu item"><a class="yui3-menu-label yui3-menuitem-content" href="#' + id + '">Alt menyu</a><div id="' + id + '" class="yui3-menu"><div class="yui3-menu-content"><ul><li class="yui3-menuitem item"><a class="yui3-menuitem-content" href="#">Новый пункт</a></li></ul></div></div></li>'
                    if (node.hasClass('item-menu'))
                ...
                function itemChange(node) {
                    var name = window.prompt("yeni punkt adı daxil et", node.one('a').text());
                    if (name)
                        node.one('a').text(name);
                    if (!node.hasClass('item-menu')) {
                        var host = window.prompt("ünvan daxil et", node.one('a').getAttribute('href'));
                        if (host)
                ...
                A.one("#top").on("click", function () {
                    var D = new Date();
                    var id = 'li_' + D.getTime() + '-' + user;
                    var str = '<li class="yui3-menuitem item-menu item"><a class="yui3-menu-label yui3-menuitem-content" href="#' + id + '">Подменю</a><div id="' + id + '" class="yui3-menu"><div   class="yui3-menu-content"><ul><li class="yui3-menuitem item"><a class="yui3-menuitem-content" href="#">Yeni punkt</a></li></ul></div></div></li>'
