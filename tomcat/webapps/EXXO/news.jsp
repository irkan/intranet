    ...
    <body class="yui-skin-sam yui3-skin-sam" id="news_jsp">
        <div id="content-wrapper">
            <div id="header">
                <table id="tableH">
                    <tbody>
                        <tr>
                            <td id="tdlogo"><img src="logo.png" id="logo">
                            </td>
                            <td>
                                <div id="head">
                                    <table>
                    ...
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="plus">
                                ...
                                <a href="javascript:;" id="pl">Xəbər əlavə et</a>
                            </div>
                            <%}%>
                        </td>
        ...
        <div id="editor"> 
            ...
            <form action="news" method="post" id="forma">
                ...
                <textarea name="msgpost" id="msgpost" cols="50" rows="10"></textarea><input type="submit" id='submit' value="Yadda saxla">
            </form>
        </div>
        <div id="imges">
            <div id="imgesInner">
        ...
        <div id="imger">
            <div id="closser"><span>BAĞLA</span></div>
