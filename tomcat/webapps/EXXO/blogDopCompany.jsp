...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="LIST" class="BEANS.blogDopCompany" scope="page"/><%
...
<html>
    <head>
        ...
        <style>
            <%=CSS3.getCSS("blogDopCompany.jsp", request)%>
        </style>
    </head>
    <body id="blogDopCompany_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="blogInsert.jsp?edit=1&r=1" class="footmenu">Sonlandır</a></li>
                                        <li> <a href="http://exxo.ru/howto/mail-howto.html#tags" class="footmenu howto" target="_blank">?</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                ...
                A.one("#main").plug(A.Plugin.IO, {uri: 'company', method: 'POST', on: {"end": function () {
                            A.all("#main .item").each(function () {
                                ...
                                this.on("click", function () {
                                    location = "blogDopComp.jsp?uid=" + this.getAttribute("id");
                                })
                            })
                        }}});
            });
