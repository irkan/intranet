...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="FG" class="BEANS.tagsGalBean" scope="page"/><%
...
<html>
    <head>
        ...
        <title>Результаты поиска в базе знаний: картинки</title>
        ...
        <style type="text/css">
            ...
            table#small div#main div.cat1 {background-image: url("small/photo_album.png");background-position: left;background-repeat: no-repeat;
                                           padding-left: 30px;}
        ...
        <style>
            <%=CSS3.getCSS("openTagsGal.jsp", request)%>
        </style>
    </head>
    <body class="yui3-skin-sam" id="openTagsGal_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="findTag.jsp?s=gallaries" class="footmenu">Назад</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="menuList"><a href="openTags.jsp?s=gallaries">В виде списка</a></div>
                        </td>
