...
<html>
    <head>
        ...
        <title>Resursların siyahısı</title>
        ...
        <style type="text/css">
            ...
            .first {width:40%;padding-top:10px;}
            .second{width:60%;padding-top:10px;}
        ...
        <style>
            <%=CSS3.getCSS("resources.jsp", request)%>
        </style>
    </head>
    <body class="yui3-skin-sam" id="resources_jsp">
        <div id="content-wrapper"><div id="header">
                <table id="tableH">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    ...
                                    <a href="resourceMod.jsp" class="footmenu">Redaktə et</a>
            ...
            AUI().ready('aui-node', function (A) {
                A.all("#content .datas").each(function () {
                    ...
                    this.on("click", function () {
                        location = "allDayR.xhtml?r=" + this.one(".first").getAttribute("id");
                    });
