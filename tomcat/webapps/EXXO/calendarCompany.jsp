...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="LIST" class="BEANS.calendarCompany" scope="page"/><%
                    ...
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            <div id="dopusks" class="exxo-shadow">
                                <div id="fname"><%=name%></div><div id="empsH">Допущены:</div><div id="empsDiv">
                                    <%=d%></div></div></td>
                ...
                A.one("#main").plug(A.Plugin.IO, {uri: 'company', method: 'POST', on: {"end": function () {
                            A.all("#main .item").each(function () {
                                ...
                                this.on("click", function () {
                                    location = "calendarComp.jsp?uid=" + this.getAttribute("id") + "<%=ldate%>";
                                })
                            })
                        }}});
            });
