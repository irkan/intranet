...
<html>
    ...
    <body id="gallariesMod_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="galClassic.jsp<% if (owner != null) {%>?owner=<%=owner%><%}%>" class="footmenu">Sonlandır</a></li>
        ...
        <div class="menu1 aui-overlaycontext-hidden exxo-shadow"><ul>
                <li class="item-add c  "><a >Albom yarat</a></li>
                <li class="item-move f np"><a >Yerini dəyişdir</a></li>
                <li class="item-kill np"><a >Удалить</a></li>
                <li class="item-change np" id="item-change"><a >Adini dəyişdir</a></li>
                <li class="file-change np" id="file-change"><a >Məlumatı dəyişdir</a></li>
                <li class="file-add c np" id="file-add"><a >Şəkli saxla</a></li>
                <li class="files-add c np" id="files-add"><a >Şəkilləri saxla</a></li>
                <li class="tags-add f np"><a >Teq əlavə et</a></li>
                <li class="cover f np"><a >Qapaq (Üz) yarat</a></li>
            </ul></div>
        <div id="form"><div class="close" id="close"><span>BAĞLA</span></div>
            <form id="FILEFORM" action="addPic" enctype="multipart/form-data" method="POST">
                <label for="file">Şəkil seçin</label><input type="file" name="file" id="file">
                <label for="name">Faylın adı</label><input type="text" name="name" id="name" maxlength="50">
                <label for="discription">Açıqlama</label><textarea name="discription" rows="5" cols="22" ></textarea>
                <label for="tags">Teqlər</label><textarea name="tags" rows="5" cols="22" ></textarea><br><br>
                <input type="checkbox" value="1" name="notshow"><label class="notshow">Reklam etmə</label>
                <br><br>
        ...
        <div id="hic">
            <div class="close" id="closehic"><span>BAĞLA</span></div>
            <div id="mhic"></div>

        </div>
        <div id="moveMain">
            <div id="imgesInner">
                <div class="exxo-close" id="closeM"><span>BAĞLA</span></div>
