    ...
    <body id="pic_jsp">
                    ...
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id='lMenu' class='exxo-shadow'>
                                <a href='javascript:;'   class='own' id='nameChange'>Adını dəyişdir</a><a href='javascript:;'   class='own' id='fileChange'>Məlumatı dəyişdir</a><a href='javascript:;' id='cover' >Qapaq (Üz) yarat</a><a href='javascript:;' id='moveFile' >Yerini dəyişdir</a><a href='javascript:;' id='tagPhoto'>Teq əlavə et</a><a href='javascript:;' id='dropPhoto'>Sil</a></div><%}%>
                        ...
                        <td id="column-3" valign="top">
                            <div id="content" class="exxo-shadow">
                                ...
                                <div id="innerContent">
                                    ...
                                    <div id="res">
                                        <span>Baxışlar: <%=BLOG.count%> </span><span>Şərhlər: <%=BLOG.commcount%> </span><span>Bəyənildi: <%=BLOG.respcount%> </span>
                                    </div>
                                    <div id="buts">
                                        <a href="javascript:;" id="addComment">ŞƏRH YAZ</a><a href="pic.jsp?respect=1&id=<%= id%>">BƏYƏNİLDİ!</a>
                                    </div>
                                    <table id="info">
                                        <tr>
                                            <td id="inform">
                                                ...
                                                <%=BLOG.tags%>
                                                <%if (inspector) {%> <div id="block"><a href="changePicStatus.jsp?id=<%= id%>">Blok et</a></div><% }%>
                                            </td><td id="comments">
                                                <%=BLOG.getComments()%>
                                            </td></tr></table>
        ...
        <div id="commentator"> 
            ...
            <form action="commentPic" method="post" id="forma">
                ...
                <input type="submit" id='submitComment' value="Yadda saxla">
            </form>
        </div>
                <% if (editor) {%>
