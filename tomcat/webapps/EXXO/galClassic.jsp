    ...
    <body id="galClassic_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="gallariesMod.jsp<% if (owner != null) {%>?owner=<%=owner%><%}%>" class="footmenu">Redaktə et</a></li>
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <%if (editor) {%><div id='lMenu' class='exxo-shadow'><a href='javascript:;'   class='own' id='newAlbom'>Albom əlavə et</a><a href='javascript:;' id='dropAlbom' class='fotoedit' >Albomu sil</a><a href='javascript:;' id='albomName' class='fotoedit' >Albomun adını dəyiş</a>
                                <a href='javascript:;' id='newPhoto' class='fotoedit'>Foto əlavə et</a><a href='javascript:;' id='manyPhotos' class='fotoedit'>Şəkillər</a></div><%}%>
                            ...
                            <div id="menuList"><a href="photos.jsp<%=own%>">Fotolar</a></div>
                        </td>
        ...
        <div id="form"><div class="close" id="close"><span>BAĞLA</span></div>
            <form id="FILEFORM" action="addPic" enctype="multipart/form-data" method="POST">
                <label for="file">Şəkil seç</label><input type="file" name="file" id="file">
                <label for="name">Şəklin adı</label><input type="text" name="name" id="name" maxlength="50">
