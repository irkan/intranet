...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="LIST" class="BEANS.BlogDopComp" scope="page"/><%
...
<html>
    <head>
        ...
        <style><%=CSS3.getCSS("blogDopComp.jsp", request)%></style>
    </head>
    <body id="blogDopComp_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li>
                                            <a href="blogInsert.jsp?edit=1&r=1" class="footmenu">Sonlandır</a>
                                        </li>
                                        <li> 
                                            <a href="http://exxo.ru/howto/mail-howto.html#tags" class="footmenu howto" target="_blank">?</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            </div><div id="dopusks" class="exxo-shadow">
                                <div id="fname"><%=name%></div><div id="empsH">Допущены:</div>
                                <div id="empsDiv">
                                    <%=d%>
                                </div>
                            </div>
                        ...
                        <td id="column-3" valign="top">
                            <div id="moveMain">
                                <div id="upComp">
                                    <a href="blogDopCompany.jsp">Назад к структуре компании</a>
                                </div>
