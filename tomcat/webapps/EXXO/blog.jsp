    ...
    <body id="blog_jsp">
                    ...
                    <tr id="tr">
                        ...
                        <td id="column-3" valign="top">
                            <div id="content" class="exxo-shadow">
                                ...
                                <div id="bottomBlog">
                                    <a href="javascript:;" id="addComment">ŞƏRHLƏR</a>
                                    <a href="blogInsert.jsp?id=<%= id%>&r=1">CAVAB</a>
                                    <a href="blog.jsp?id=<%= id%>&amp;respect=1">RAZILAŞMA</a>
                                </div>
                                <div class="results"> 
                                    ...
                                    <%=respcount%>
                                    <a href="blog.jsp?id=<%= id%>&amp;answers=1">cavablar:</a> 
                                    <%= ansCount%>
                                    <a href="blog.jsp?id=<%= id%>&amp;comments=1">şərhlər:</a> 
                                    <%= commCount%>
                                </div>
                                <div class="results"> 
                                    <% if (a) {%>
                                    <a href="blog.jsp?id=<%= id%>">cavablamanı bitir</a>
                                    <%}%><% if (c) {%>
                                    <a href="blog.jsp?id=<%= id%>">şərhi bitir</a>
                                    <%}%>
                                </div>
                                <%= answers%><%= comments%>
                            </div>
        ...
        <div id="commentator"> 
            ...
            <form action="comment" method="post" id="forma">
                ...
                <input type="submit" id='submitComment' value="Yadda Saxla"></form></div>
        <div id="imger">
            <div id="closser">
                <span>BAĞLA</span>
            </div>
