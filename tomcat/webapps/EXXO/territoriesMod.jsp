...
<html>
    <head>
        ...
        <div id="content-wrapper"><div id="header"><table id="tableH"><tbody><tr><td id="tdlogo"><img src="logo.png" id="logo"></td><td>
                                <div id="head"><table><tbody><tr><td id="slogan" valign="center"><%= slogan%></td><td><jsp:include page="poisk" flush="true" />
                                                </td></tr></tbody></table></div><div id="foot"><ul class="topMenu"><jsp:include page="topMenu.xhtml" flush="true" /><li><a href="territories.xhtml" class="footmenu">Sonlandır</a></li>
            ...
            <table id="grid" class="grid"><tbody id="atbody"><tr id="tr"><td id="menu-td" class="menu-td" valign="top"><div class="exxo-menu exxo-shadow" id="menu"><jsp:include page="menu-emp.xhtml" flush="true" /></div></td><td id="edits" valign="top">
                            <div id="menuT" class="exxo-shadow"><div><form action="javascript:;">
                                        <select id="offices" name="offices"><option value="0" selected="selected">--Ərazini Seçin--</option><%=op%></select>
                                        <select id="action" name="action" disabled="true"><option value="0" selected="selected">--Əməliyyatı seçin--</option>
                                            <option value="changeOffice">Dəyişdirin məlumatı</option>
                                            <option value="dropOffice">Silin ofisi</option>
        ...
        <div id="addNew"><div id="close"><span>BAĞLA</span></div>
            <form action="addOffice" method="POST" id="forma" >
                <label for="short">Qısa adı</label><input id="short" type="text" name="short">
                <label for="adress">Ünvan</label><input id="adress" type="text" name="adress">
                <label for="tel">Telefon (Telefonlar)</label><input id="tel" type="text" name="tel"><br><br>
        ...
        <script type="text/javascript">
            AUI().ready('aui-button-item', 'anim-node-plugin', 'aui-overlay-mask', function (A) {
                ...
                new A.ButtonItem({icon: 'plusthick', label: 'Yeni Filial', handler: {fn: function (e) {
                ...
                new A.ButtonItem({icon: 'transferthick-r-l', label: 'Keçid', handler: {fn: function (e) {
                ...
                A.one("#action").on("change", function (e) {
                    ...
                    if (of != 0 && ac != 0) {
                        if (ac == "changeOffice") {
                            ...
                            var span = "Flialı silmək istəyirsinizmi ''" + of + "''?";
