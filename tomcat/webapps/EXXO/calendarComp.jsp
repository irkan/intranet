...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="LIST" class="BEANS.calendarComp" scope="page"/><%
...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            #dopusks {font-size: 12px; margin-left: 10px;width: 168px; border: 1px solid #dedede; border-bottom: 1px solid #bfbfbf; background-color: rgb(252,252,252);padding-bottom: 20px;}
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="<%=back%>" class="footmenu">Sonlandır</a></li>
                                        <li> 
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        ...
                        <td id="column-3" valign="top">
                            <div id="moveMain">
                                <div id="upComp">
                                    <a href="calendarCompany.jsp<%=ldate%>">Назад к структуре компании</a>
                                </div>
