...
<html>
    <head>
        ...
        <title>Strukturun Redaktəsi</title>
    ...
    <body id="companyMod_jsp">
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    <ul class="topMenu">
                                        ...
                                        <li><a href="company.xhtml" class="footmenu">Sonlandır</a></li>
        ...
        <div class="menu1 aui-overlaycontext-hidden exxo-shadow">
            <ul>
                <li class="item-add">
                    <a >yenisini əlavə et</a>
                </li>
                <li class="item-move">
                    <a >dəyişdir</a>
                </li>
                <li class="item-kill"><a >sil</a></li>
                <li class="item-change" id="item-change"><a >adını dəyiş</a>
                </li>
            </ul>
        </div>
        <div id="moveMain">
