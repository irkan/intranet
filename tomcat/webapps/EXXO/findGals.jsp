...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="FG" class="BEANS.FindGalsBean" scope="page"/><%
...
<html>
    <head>
        ...
        <title>Результаты поиска изображения</title>
        ...
        <style>
            <%=CSS3.getCSS("findGals.jsp", request)%>
        </style>
    </head>
    <body class="yui3-skin-sam" id="findGals_jsp">
                ...
                <tbody id="atbody">
                    <tr id="tr">
                        <td id="menu-td" class="menu-td" valign="top">
                            ...
                            <div id="menuList"><a href="findGalsList.jsp">В виде списка</a></div>
                        </td>
                        <td id="column-3" valign="top">
                            <div id="content" class="exxo-shadow exxo-images"><%=list%></div>
                            <%=FG.navi%>
                        </td>
                    </tr>
                </tbody>
