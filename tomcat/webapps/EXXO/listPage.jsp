...
<jsp:useBean id="CSS3" class="BEANS.css1Bean" scope="page"/><jsp:useBean id="LP" class="BEANS.ListPageBean" scope="page"/><%
    String slogan = SLOGAN.getSlogan(request);
    String list = LP.getList(request);
...
<html>
    <head>
        ...
        <title>Səhifələrin siyahısı</title>
        ...
        <style type="text/css">
            ...
            #content table td {background-color: white;margin:10px;padding:8px;width:50%;}
        </style>
        <script src="/FILES/alloy/build/aui/aui.js" type="text/javascript"></script>
        <style><%=CSS.getCSS(request)%></style><style><%=CSS3.getCSS("listPage.jsp", request)%></style>
    </head>
    <body class="yui3-skin-sam" id="listPage_jsp">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="foot">
                                    ...
                                    <a href="http://exxo.ru/howto/cms-howto.html#editpage" class="footmenu howto" target="_blank">?</a>
                                </div>
                            </td>
                        </tr>
                    </tbody>
