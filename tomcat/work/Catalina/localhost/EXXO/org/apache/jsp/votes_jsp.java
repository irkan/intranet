 ...
 * Generated at: 2018-08-27 13:25:53 UTC
...
public final class votes_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      BEANS.qwestBean T = null;
      T = (BEANS.qwestBean) _jspx_page_context.getAttribute("T", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (T == null){
        T = new BEANS.qwestBean();
    ...
    String slogan = SLOGAN.getSlogan(request);
      ...
      out.write("        <title>Актуальные опросы.</title>\n");
      ...
      out.write("            .second{width:20%;padding-top:10px;}\n");
      out.write("            .third{width:20%;padding-top:10px;}\n");
      ...
      out.write("</style>\n");
      out.write("        <style>");
      out.print(CSS3.getCSS("votes.jsp", request));
      out.write("</style>\n");
      out.write("    </head>\n");
      out.write("    <body class=\"yui3-skin-sam\" id=\"votes_jsp\">\n");
      out.write("        <div id=\"content-wrapper\"><div id=\"header\"><table id=\"tableH\"><tbody><tr><td id=\"tdlogo\"><img src=\"logo.png\" id=\"logo\"></td><td>\n");
      out.write("                                <div id=\"head\"><table><tbody><tr><td id=\"slogan\" valign=\"center\">");
      out.print( slogan);
      out.write("</td><td>");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "poisk", out, true);
      out.write("\n");
      out.write("                                                </td></tr></tbody></table></div><div id=\"foot\">");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "topMenu", out, true);
      out.write("<a href=\"qwestList.jsp\" class=\"footmenu\">Настройка</a>\n");
      out.write("                                    <a href=\"http://exxo.ru/howto/vote-howto.html\" class=\"footmenu howto\" target=\"_blank\">?</a></div>\n");
      out.write("                            </td></tr></tbody></table></div>\n");
      out.write("            <table id=\"grid\" class=\"grid\"><tbody id=\"atbody\"><tr id=\"tr\"><td id=\"menu-td\" class=\"menu-td\" valign=\"top\"><div class=\"menu\" id=\"menu\"></div></td>\n");
      out.write("                        <td id=\"column-3\" valign=\"top\"><div id=\"container\" class=\"exxo-shadow\"><div id=\"content\">");
      out.print(list);
      out.write("</div></div></td></tr></tbody></table>");
      ...
      out.write("                        location = \"question.jsp?id=\" + this.one(\".first\").get(\"id\")\n");
      out.write("                    });\n");
