 ...
 * Generated at: 2018-08-16 10:31:07 UTC
...
public final class addDopusk_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      BEANS.addDopuskBean LIST = null;
      LIST = (BEANS.addDopuskBean) _jspx_page_context.getAttribute("LIST", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (LIST == null){
        LIST = new BEANS.addDopuskBean();
    ...
    if (!LIST.ok) {
      ...
      out.write("            #list, #result {font-size: 12px;margin:0;background-color: white; width: 100%;}\n");
      out.write("            #list td, #result td {padding: 4px;border-bottom-color: #DEDEDE;border-bottom-style: solid;border-bottom-width: 1px;}\n");
      out.write("            #test {margin-left: 20px;}\n");
      out.write("            #content {margin:10px; margin-top: 0px; width:90%;}\n");
      ...
      out.write("</style>\n");
      out.write("        <style>");
      out.print(CSS3.getCSS("addDopusk.jsp", request));
      out.write("</style>\n");
      out.write("    </head>\n");
      out.write("    <body id=\"addDopusk_jsp\">\n");
      ...
      out.write("                                        <li> \n");
      out.write("                                            <a href=\"http://exxo.ru/howto/documents-howto.html#admit\" class=\"footmenu howto\" target=\"_blank\">?</a>\n");
      out.write("                                        </li>\n");
      out.write("                                    </ul>\n");
      out.write("                                </div>\n");
      out.write("                            </td>\n");
      ...
      out.write("                                <div id=\"toFind\">\n");
      out.write("                                    <form action=\"javascript:;\">\n");
      out.write("                                        <label for=\"fio\">Введите несколько букв</label>\n");
      out.write("                                        <input type=\"text\" name=\"fio\" id=\"fio\"> \n");
      out.write("                                        <label for=\"start\"> Начальные буквы</label>\n");
      out.write("                                        <input type=\"checkbox\" name=\"start\" id=\"start\" checked>\n");
      ...
      out.write("            AUI().ready('aui-node', 'aui-button-item', 'aui-io', function (A) {\n");
      out.write("                A.all(\"#list tr\").each(function () {\n");
      out.write("                    this.on(\"mouseenter\", function () {\n");
      out.write("                        this.addClass(\"hover\")\n");
      out.write("                    });\n");
      out.write("                    this.on(\"click\", function () {\n");
      out.write("                        location = \"addDopusk?dopusk=\" + this.one(\".fio span\").getAttribute(\"id\") + \"&id=");
      out.print(id);
      out.write("&owner=");
      out.print(owner);
      out.write("\"\n");
      ...
      out.write("                    });\n");
      out.write("                });\n");
      out.write("                new A.ButtonItem({icon: 'search', label: 'Искать', handler: {fn: function (e) {\n");
      out.write("                            A.one(\"#list\").setStyle(\"display\", \"none\");\n");
      out.write("                            if (A.one(\"#result\") !== null)\n");
      out.write("                                A.one(\"#result\").remove();\n");
      out.write("                            var res = A.Node.create(\"<table id='result'><tbody></tbody></table>\");\n");
      out.write("                            res.appendTo(A.one(\"#content\"));\n");
      out.write("                            A.all(\"#list tr\").each(function () {\n");
      out.write("                                if (!A.one(\"#start\").get('checked')) {\n");
      out.write("                                    if (this.one(\".fio\").text().toLowerCase().indexOf(A.one(\"#fio\").get(\"value\").toLowerCase()) >= 0)\n");
      out.write("                                        this.cloneNode(true).appendTo(\"#result\");\n");
      out.write("                                } else {\n");
      out.write("                                    if (this.one(\".fio\").text().toLowerCase().indexOf(A.one(\"#fio\").get(\"value\").toLowerCase()) == 0)\n");
      out.write("                                        this.cloneNode(true).appendTo(\"#result\");\n");
      out.write("                                }\n");
      out.write("                            });\n");
      out.write("                            A.all(\"#result tr\").each(function () {\n");
      out.write("                                this.on(\"mouseenter\", function () {\n");
      out.write("                                    this.addClass(\"hover\")\n");
      out.write("                                });\n");
      out.write("                                this.on(\"click\", function () {\n");
      ...
      out.write("                                });\n");
      out.write("                            });\n");
      out.write("                        }}}).render(this.one(\"#test\"));\n");
      out.write("                function dropRegistrat() {\n");
      out.write("                    dropAr = \"\";\n");
      out.write("                    A.all(\".emps\").each(function () {\n");
      out.write("                        this.on(\"click\", function () {\n");
      out.write("                            if (confirm(\"Удалить?\"))\n");
      out.write("                                empsDrop(this)\n");
      out.write("                        })\n");
      out.write("                    });\n");
      out.write("                    A.one('#dopusks').setStyle('height', A.one('#dopusks').getComputedStyle('height'));\n");
      out.write("                }\n");
